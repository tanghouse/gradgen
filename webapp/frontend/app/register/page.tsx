...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Show success message (don't auto-login, need email verification)
      setSuccess(true);
      ...
      <main className="flex-grow flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-center text-gray-600 mb-8">Get 5 free credits to start!</p>
            ...
            {success && (
              <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-green-900 font-semibold mb-1">Registration Successful!</h3>
                ...
                <div className="mt-4">
                  <Link
                    href="/login"
                    className="block text-center w-full bg-green-600 text-white py-2 rounded-lg font-semibold hover:bg-green-700"
                  >
                    Go to Login
                  </Link>
                </div>
